...
<div class="card mt-3 shadow-sm">
        ...
        <div class="card-header py-3 d-flex justify-content-between">
                <h6 class="m-0 font-weight-bold text-dark"><i class="fa fa-cogs" aria-hidden="true"></i> Pilih Tipe Kulit dan Kategori Produk</h6>
        </div>
        <form id="periodeForm">
                <div class="row mt-3">
                        <div class="col-md-3">
        ...
        <div class="card mt-4 shadow-sm">
                <div class="card-header py-3 d-flex justify-content-between">
                        ...
                        <div class="<?= $tipe_kulit == null ? 'd-none' : '' ?>">
                                ...
                                <a href="<?= base_url('hasil/hapus/' . $tipe_kulit . '/' . $id_kategori) ?>" class="btn btn-danger">Hapus</a>
                        </div>
                </div>
                                        ...
                                        <tbody>
                                                ...
                                                <?php foreach ($hasil as $row) : ?>
                                                        <tr>
                                                                <td><?= $no++ ?></td>
                                                                <td>
                                                                        <?= $row['kode_tipekulit'] == 'a1' ? 'Semua Jenis Kulit' : ($row['kode_tipekulit'] == 'a2' ? 'Normal' : ($row['kode_tipekulit'] == 'a3' ? 'Kering' : (($row['kode_tipekulit'] == 'a4' ? 'Berminyak' : (($row['kode_tipekulit'] == 'a5' ? 'Sensitif' : 'Sensitif')))))) ?>
                                                                </td>
                                                                <td>
                                                                        <?php foreach ($kategoriProduk as $data) : ?>
