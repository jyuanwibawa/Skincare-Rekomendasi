...
$routes->get('hasil-rekomendasi/(:any)/(:any)', 'Visitor::hasilRekomendasi/$1/$2');

//$routes->post('/form-rekomendasi/add', 'Visitor::saveDataFormVisitor');
$routes->post('/form-rekomendasi/add', 'Visitor::simpanRekomendasi');
$routes->post('/hasil-rekomendasi-akhir', 'Visitor::hasilAkhirRekomendasi');
